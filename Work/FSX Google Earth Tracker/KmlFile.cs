...
namespace Fsxget
{
	public abstract class KmlFile
	{
        ...
        {
            String strKmlPart = File.ReadAllText( Program.Config.AppPath + "\\data\\" + strName + ".part" );
        ...
        {
            strKml = strKml.Replace("%SERVER%", Program.Config.Server);
            // TODO: Translate static Labels in the current language
            strKml = strKml.Replace("%TITLE%", Program.Config.AssemblyTitle);
            return strKml;
        }
    ...
    public abstract class KmlFileFsx : KmlFile
    {
        ...
        protected StringBuilder GetStringBuilder(int nInterval)
        {
            ...
            strKml.Append(Program.Config.Server);
    ...
    public class KmlFileUserPosition : KmlFileFsx
    {
        ...
        public override String GetKmlFile()
        {
            StringBuilder strbKml = GetStringBuilder(Program.Config[Config.SETTING.QUERY_USER_AIRCRAFT]["Interval"].IntValue / 1000);
    ...
    public class KmlFileUserPathPrediction : KmlFileMovingObject
    {
        ...
        public override string GetKmlFile()
        {
            StringBuilder strbKml = GetStringBuilder(Program.Config[Config.SETTING.USER_PATH_PREDICTION]["Interval"].IntValue / 1000);
            lock (fsxCon.lockUserAircraft)
            {
                if (fsxCon.objUserAircraft != null)
                {
    ...
    public class KmlFileUserPath : KmlFileFsx
    {
        ...
        public override string GetKmlFile()
        {
            StringBuilder strbKml = GetStringBuilder(Program.Config[Config.SETTING.QUERY_USER_PATH]["Interval"].IntValue / 1000);
            lock (fsxCon.lockUserAircraft)
            {
                if (fsxCon.objUserAircraft != null)
                {
    ...
    public class KmlFileAIObject : KmlFileMovingObject
    {
        ...
        public override string GetKmlFile()
        {
            StringBuilder strbKml = GetStringBuilder(Program.Config[cfgSetting]["Interval"].IntValue / 1000);
    ...
    public class KmlFileNavaid : KmlFileFsx
    {
        ...
        public override string GetKmlFile()
        {
            StringBuilder strbKml = GetStringBuilder(Program.Config[Config.SETTING.QUERY_NAVAIDS]["Interval"].IntValue);
